...
: QUIT R0 RSP! BEGIN ?STACK WORD INTERPRET AGAIN ;
...
;
: UNUSED ( -- n ) PAD HERE @ - 4/ ;
\ clear stacks and jump back into the interpreter
...
: LIST.FILTER >R BEGIN DUP LIST.CAR R> DUP >R EXECUTE DUP LIST.CDR 0= IF DROP TRUE ELSE LIST.CDR FALSE THEN UNTIL R> DROP ;
VARIABLE LIST.PRODUCT
: LIST.REDUCE DUP LIST.CAR LIST.PRODUCT ! LIST.CDR >R BEGIN DUP LIST.CAR LIST.PRODUCT @ R> DUP >R EXECUTE LIST.PRODUCT ! DUP LIST.CDR 0= IF DROP TRUE ELSE LIST.CDR FALSE THEN UNTIL R> DROP ;
...
2021505C CONSTANT AUX_SCRATCH
20215060 CONSTANT AUX_CNTL
20215064 CONSTANT AUX_STAT
...
: UARTRAWKEY BEGIN UARTINREADY UNTIL UARTGET DUP BREAK_TEST ;
: UARTKEY UARTRAWKEY DUP 13 = IF DROP 10 THEN ;
UARTINIT
